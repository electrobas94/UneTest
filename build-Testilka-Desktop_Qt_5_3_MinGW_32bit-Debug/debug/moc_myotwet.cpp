/****************************************************************************
** Meta object code from reading C++ file 'myotwet.h'
**
...
#include "../../Testilka/myotwet.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'myotwet.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MyRadio_t, stringdata) + ofs \
...
const QMetaObject MyRadio::staticMetaObject = {
    { &QRadioButton::staticMetaObject, qt_meta_stringdata_MyRadio.data,
      qt_meta_data_MyRadio,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyRadio.stringdata))
